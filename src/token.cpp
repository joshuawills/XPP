...
auto get_type_from_lexeme(std::string const& str) -> std::optional<TokenType> {
    auto const lookup_map =
        std::map<std::string, TokenType>{{"fn", TokenType::FN},           {"using", TokenType::USING},
                                         {"as", TokenType::AS},           {"i64", TokenType::TYPE},
                                         {"i32", TokenType::TYPE},        {"i8", TokenType::TYPE},
                                         {"u64", TokenType::TYPE},        {"u32", TokenType::TYPE},
                                         {"u8", TokenType::TYPE},         {"f64", TokenType::TYPE},
                                         {"f32", TokenType::TYPE},        {"if", TokenType::IF},
                                         {"else", TokenType::ELSE},       {"else if", TokenType::ELSE_IF},
                                         {"bool", TokenType::TYPE},       {"void", TokenType::TYPE},
                                         {"mut", TokenType::MUT},         {"let", TokenType::LET},
                                         {"return", TokenType::RETURN},   {"extern", TokenType::EXTERN},
                                         {"while", TokenType::WHILE},     {"true", TokenType::TRUE},
                                         {"false", TokenType::FALSE},     {"enum", TokenType::ENUM},
                                         {"pub", TokenType::PUB},         {"class", TokenType::CLASS},
                                         {"size_of", TokenType::SIZE_OF}, {"and", TokenType::LOGICAL_AND},
